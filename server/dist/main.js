...
class VehicleImagesComponent {
    constructor(route, gqlQuery, filterService, _snackBar) {
        this.route = route;
        this.gqlQuery = gqlQuery;
